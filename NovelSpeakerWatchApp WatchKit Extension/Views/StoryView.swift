...
class StoryViewData:ObservableObject,StorySpeakerDeletgate {
    ...
    @Published var combinedBlockArray:[CombinedSpeechBlock] = [
        CombinedSpeechBlock(block: SpeechBlockInfo(speechText: NSLocalizedString("WatchOS_NowloadingText", comment: "読込中……"), displayText: NSLocalizedString("WatchOS_NowloadingText", comment: "読込中……"), voiceIdentifier: nil, locale: nil, pitch: 1.0, rate: 1.0, volume: 1.0, delay: 0.0, isMod: false))
    ] {
