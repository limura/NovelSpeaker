...
- (NSDictionary*)GetDefaultSpeechModConfigForRegexp
{
    return @{
             ...
             @"([0-9０-９零壱弐参肆伍陸漆捌玖拾什陌佰阡仟萬〇一二三四五六七八九十百千万]+)\\s*〜\\s*([0-9０-９零壱弐参肆伍陸漆捌玖拾什陌佰阡仟萬〇一二三四五六七八九十百千万]+)": @"$1から$2", // 100〜200 → 100から200
             @"([0-9０-９零壱弐参肆伍陸漆捌玖拾什陌佰阡仟萬〇一二三四五六七八九十百千万]+)\\s*話": @"$1は", // 29話 → 29は
    };
}
