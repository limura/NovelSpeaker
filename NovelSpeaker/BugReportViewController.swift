...
class BugReportViewController: FormViewController, MFMailComposeViewControllerDelegate {
    ...
    */
    ...
    @discardableResult
    func sendBugReportMail(log:String?, description:String, procedure:String, date:Date, needResponse:String, targetNovelSet:Set<RealmNovel>, completion:(() -> Void)? = nil) -> Bool {
        if !MFMailComposeViewController.canSendMail() {
            return false;
        }
