...
class NovelDisplayColorSettingViewController: FormViewController, UIPopoverPresentationControllerDelegate, MSColorSelectionViewControllerDelegate {
    ...
    */
    ...
    func getForegroundColor() -> UIColor {
        if let globalData = GlobalDataSingleton.getInstance(), let color = globalData.getReadingColorSettingForForegroundColor() {
            return color
        }
    ...
    func getBackgroundColor() -> UIColor {
        if let globalData = GlobalDataSingleton.getInstance(), let color = globalData.getReadingColorSettingForBackgroundColor() {
            return color
        }
        if #available(iOS 13.0, *) {
    ...
    func saveColor(foregroundColor:UIColor?, backgroundColor:UIColor?) {
        ...
        globalData.setReadingColorSetting(forForegroundColor: foregroundColor)
        globalData.setReadingColorSetting(forBackgroundColor: backgroundColor)
    }
